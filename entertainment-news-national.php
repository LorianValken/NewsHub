...
<style>
    :root {
        ...
        --entertainment-accent: #f43f5e; /* Pinkish-Red for Entertainment */
        --bg-light: #f8f9fa;
        --text-dark: #111827;
        --border-radius: 12px;
    ...
    .header-subtitle::after {
        ...
        width: 50px;
        height: 3px;
        background: var(--entertainment-accent); /* Pink accent */
        margin: 15px auto 0;
        border-radius: 2px;
    }
...
<main class="entertainment-news-page">
    ...
    <section class="page-header">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="header-title">National Entertainment News</h1>
                    <p class="header-subtitle">Celebrity gossip, movies, music, and pop culture updates.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <?php 
                    ...
                    get_post_news('entertainment', 'national', $offset, $limit); 
                ?>
            </div>
                ...
                <div class="col-12">
                    <div class="pagination-container">
                        <ul class="pagination-list">
                            <?php 
                                $total_news = count_post_news('entertainment', 'national');
