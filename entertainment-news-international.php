...
<style>
    :root {
        ...
        --intl-ent-accent: #8b5cf6; /* Violet/Purple for International Entertainment */
        --bg-light: #f8f9fa;
        --text-dark: #111827;
        --border-radius: 12px;
    ...
    .header-subtitle::after {
        ...
        width: 50px;
        height: 3px;
        background: var(--intl-ent-accent); /* Violet accent */
        margin: 15px auto 0;
        border-radius: 2px;
    }
...
<main class="entertainment-news-page">
    
    <section class="page-header">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="header-title">International Entertainment</h1>
                    <p class="header-subtitle">Hollywood, Global Music, Cinema, and World Trends.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <?php 
                    ...
                    get_post_news('entertainment', 'international', $offset, $limit); 
                ?>
            </div>
                ...
                <div class="col-12">
                    <div class="pagination-container">
                        <ul class="pagination-list">
                            <?php 
                                $total_news = count_post_news('entertainment', 'international');
