...
<style>
    :root {
        --primary-color: #27306D; /* Deep Blue base */
        --social-accent: #10b981; /* Green accent for Social News */
        --bg-light: #f8f9fa;
        --text-dark: #111827;
        --border-radius: 12px;
...
<main class="social-news-page">
    ...
    <section class="page-header">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="header-title">International Social News</h1>
                    <p class="header-subtitle">Updates on society, culture, and community events.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <?php 
                    ...
                    get_post_news('social', 'international', $offset, $limit); 
                ?>
            </div>
                ...
                <div class="col-12">
                    <div class="pagination-container">
                        <ul class="pagination-list">
                            <?php 
                                $total_news = count_post_news('social', 'international');
                                ...
                                for($i=1; $i <= $total_page; $i++) {
                                    if ($total_page > 5) {
                                        if ($i == 1 || $i == $total_page || ($i >= $page - 1 && $i <= $page + 1)) {
                                            ...
                                            echo '<li class="hide-mobile"><a class="disabled" href="javascript:void(0)">...</a></li>';
                                        }
                                    } else {
                                        $activeClass = ($i == $page) ? 'active' : '';
                                        echo '<li><a class="'.$activeClass.'" href="?page='.$i.'">'.$i.'</a></li>';
